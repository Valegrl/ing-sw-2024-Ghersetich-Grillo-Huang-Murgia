...
class LobbyTest {
    ...
    void addPlayerToLobbySuccessfully() {
        Lobby lobby = new Lobby("NameID", "player1", 2);
    ...
    void lobbyConstructorThrowsExceptionWhenUsernameIsNull() {
        assertThrows(NullPointerException.class, () -> new Lobby("NameID", null, 2));
    }

    @Test
    void lobbyConstructorThrowsExceptionWhenRequiredPlayersIsInvalid() {
        assertThrows(IllegalArgumentException.class, () -> new Lobby("NameID", "player1", 5));
        assertThrows(IllegalArgumentException.class, () -> new Lobby("NameID", "player1", 1));
    }
